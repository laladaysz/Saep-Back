...
SECRET_KEY = 'django-insecure-l!8u@ydzitjy@o0w76jz76iu7^g3s$!7z@1%*ih+yg0wmw8r5e'
...
CORS_ALLOWED_ORIGINS = [
    'http://localhost:3000',  # Para permitir o acesso do frontend React
]

# Django Rest Framework settings
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # Permissão aberta, pode ser alterada para autenticação
    ],
